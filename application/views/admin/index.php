...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="#" data-toggle="modal" data-target="#tambahModal" class="btn btn-sm btn-primary shadow-sm">Tambah data admin</a>
	</div>
	<div class="row">
		<div class="col-lg-12">
						...
						<tbody>
							...
							<?php foreach ($admin->result() as $o) : ?>
								<tr>
									...
									<td>
										<a href="<?php echo site_url('admin/hapus/') . $o->id; ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
