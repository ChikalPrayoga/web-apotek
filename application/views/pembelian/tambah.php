    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4" id="card-transaksi">
            ...
            <div class="card-body">
                ...
                <form action="" method="post" class="form-obat-beli">
                            ...
                            <thead class="thead-success">
                                <tr class="bg-success text-white">
                                    <th scope="col" width="50">
                                        <button title="hapus semua item" class="btn btn-sm btn-circle btn-danger btn-remove-item-beli" type="button"><i class="fa fa-trash"></i></button>
                                    </th>
