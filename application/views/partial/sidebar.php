<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('dashboard'); ?>">
		...
		<div class="sidebar-brand-text mx-3">Apotek <br>Timur Jaya</div>
	</a>
	...
	<li class="nav-item <?php echo active_link(['pembelian', 'pembelian/tambah']) ?>">
		...
		<div id="collapseFour" class="collapse <?php echo active_link(['pembelian', 'pembelian/tambah'], 'show') ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
